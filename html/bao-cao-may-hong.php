...
<html
  ...
  <body>
						...
						<div class="card">
							<div class="card-body">
								...
								<form role="form" autocomplete="off">
									...
									<div class="form-group row">
										<label for="date" class="col-sm-3 col-form-label">Tên PC</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="PCName" autocomplete="off" required>
										</div>
									</div>
									
									<div class="form-group row">
										<label for="date" class="col-sm-3 col-form-label">Nội dung</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="PCcontent" autocomplete="off" required>
										</div>
									</div>
									
									<div class="form-group row justify-content-center">
										<div class="col-sm-4 text-center">
											<button style="width: 100%" type="button" onclick="upReport()" class="btn btn-primary btn-block">BÁO CÁO</button>
										</div>
									</div>
								</form>
							</div>
	...
	<script src="../assets/js/reportpc.js?k=<?=time()?>"></script>
