...
<html
  ...
  <body>
									...
									<div class="row justify-content-end pt-3">
										<div class="col-sm-4 col-md-4 col-lg-4">
											<b style="font-size: 18px" onclick="AddModal()" class="badge bg-primary cursor-pointer text-white">
												<i class="fa-solid fa-user-plus"></i> Thêm phòng máy
											</b>
										</div>
									</div>
								</div>
									...
									<table class="table table-hover align-items-center mb-0">
										<thead>
											<tr>
												...
												<th class="align-middle text-center text-uppercase text-dark"><b>Phòng</b></th>
												<th class="align-middle text-center text-center text-uppercase text-dark"><b>Mã phòng</b></th>
												<th class="align-middle text-center text-center text-uppercase text-dark"><b>Số lượng máy</b></th>
											</tr>
										</thead>
										<tbody id="ShowCustomers">
										<?php
											$allCustomers = $ketnoi->query("SELECT * FROM `phongmay`");
											$customerCount = 0;
											while ($row = $allCustomers->fetch_array()) {
												...
												echo '
													<tr class="cursor-pointer" onclick=\'OpenInfoModal(`{"id": '.$row['ID'].', "code": "'.$row['CODE'].'", "room": "'.$row['ROOM'].'", "amount": "'.$row['AMOUNT'].'"}`)\'>
														<td class="align-middle text-center">
															<span class="text-secondary text-xs font-weight-bold">'.$customerCount.'</span>
														</td>
														
														<td class="align-middle text-center">
															<span class="text-secondary text-xs font-weight-bold">'.$row['ROOM'].'</span>
														</td>
          ...
          <!-- Content wrapper -->
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Thêm phòng máy mới</h5>
								...
								<div class="container">
									<div class="row pt-3">
										...
										<div class="col-sm-7 col-md-7 col-lg-7">
											<input realm-tag="AddRoomName" class="form-control form-control-sm" placeholder="Điền tên phòng máy"/>
										</div>
									</div>
									
									<div class="row pt-3">
										<div class="col-sm-5 col-md-5 col-lg-5">
											<label class="form-control-label">Mã phòng:</label>
										</div>
										<div class="col-sm-7 col-md-7 col-lg-7">
											<input realm-tag="AddRoomCode" class="form-control form-control-sm" placeholder="Điền mã phòng máy"/>
										</div>
									</div>

									<div class="row pt-3">
										<div class="col-sm-5 col-md-5 col-lg-5">
											<label class="form-control-label">Số lượng máy:</label>
										</div>
										<div class="col-sm-7 col-md-7 col-lg-7">
											<input realm-tag="AddRoomAmount" class="form-control form-control-sm" type="number" placeholder="Điền số lượng máy"/>
										</div>
									</div>
								</div>
							</form>
						...
						<div class="modal-footer">
							<button onclick="AddRoom()" type="button" class="btn btn-success">Thêm ngay</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal fade" id="modalInfoLoader" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="modalInfoTitle">Thông tin phòng máy:</h5>
										...
										<form role="form" autocomplete="off">
											<div class="container">
												...
												<div class="col-sm-5 col-md-5 col-lg-5">
													...
													<div class="col-sm-7 col-md-7 col-lg-7">
														<input realm-tag="InfoRoomName" class="form-control form-control-sm" placeholder="Điền tên phòng máy"/>
													</div>
												</div>
												...
												<div class="row pt-3">
													...
													<div class="col-sm-7 col-md-7 col-lg-7">
														<input realm-tag="InfoRoomCode" class="form-control form-control-sm" placeholder="Điền mã phòng máy"/>
													</div>
												</div>
												...
												<div class="row pt-3">
													...
													<div class="col-sm-7 col-md-7 col-lg-7">
														<input realm-tag="InfoRoomAmount" class="form-control form-control-sm" type="number" placeholder="Điền số lượng máy"/>
													</div>
												</div>
											</div>
										</form>
	...
	<script src="../assets/js/manageRoom.js?k=<?=time()?>"></script>
