...
<html
  ...
  <body>
					...
					<div class="card">
						<div class="card-body" style="overflow-x: auto;">
							<h5 class="card-title text-primary">
								<div class="row">
									<div class="col-sm-6">
										<i class="fa-solid fa-calendar-days"></i> Lịch đăng ký phòng máy trong tuần
									</div>
									
									<div class="col-sm-6 d-flex justify-content-end">
										<span onclick="changeTimetable(-1)" class="btn btn-info" style="margin-right: 10px">
											<i class="fa fa-angle-left"></i> &nbsp; Trở về
										</span>
										
										<span onclick="changeTimetable(1)" class="btn btn-info">
	...
	<script src="../assets/js/calendar.js?k=<?=time()?>"></script>
