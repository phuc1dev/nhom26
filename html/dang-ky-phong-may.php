...
<html
  ...
  <body>
							...
							<div class="card-body">
								<h5 class="card-title text-primary">
									<div class="pb-2 text-center">
										<b>ĐĂNG KÝ LỊCH DẠY PHÒNG MÁY</b>
										<hr>
									</div>
								</h5>
								...
								<form role="form" autocomplete="off">
									<div class="form-group row">
										<label for="date" class="col-sm-3 col-form-label">Tên môn học</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="subjectName" autocomplete="off" required>
										</div>
									</div>
									
									<div class="form-group row">
										<label for="date" class="col-sm-3 col-form-label">Chọn Ngày</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="datepicker" autocomplete="off" required>
										</div>
									</div>
									<div class="form-group row">
										<label for="room" class="col-sm-3 col-form-label">Chọn Phòng Máy</label>
										<div class="col-sm-9">
											<select class="form-control" id="room" required>
												<option value="" selected disabled></option>
												
												<?php
													$getAllPhongMay = $ketnoi->query("SELECT * FROM `phongmay`");
													while ($row = $getAllPhongMay->fetch_array()) {
														echo '<option value="'.$row['CODE'].'">'.$row['ROOM'].'</option>'."\n";
													}
												?>
												<!-- Thêm các phòng máy khác vào đây -->
											</select>
										</div>
									</div>
									<div class="form-group row">
										<label for="startPeriod" class="col-sm-3 col-form-label">Tiết Bắt Đầu</label>
										<div class="col-sm-9">
											<select class="form-control" id="startPeriod" required>
												<option value="" selected disabled></option>
												<!-- Thêm các tiết khác vào đây -->
											</select>
										</div>
									</div>
									<div class="form-group row">
										<label for="endPeriod" class="col-sm-3 col-form-label">Tiết Kết Thúc</label>
										<div class="col-sm-9">
											<select class="form-control" id="endPeriod" required>
												<option value="" selected disabled></option>
												<!-- Thêm các tiết khác vào đây -->
											</select>
										</div>
									...
									<div class="form-group row justify-content-center">
										<div class="col-sm-4 text-center">
											<button style="width: 100%" type="button" onclick="regCalendar('<?=getGVCode()?>')" class="btn btn-primary btn-block">ĐĂNG KÝ</button>
										</div>
									</div>
								</form>
							</div>
	...
	<script src="../assets/js/reg-calendar.js?k=<?=time()?>"></script>
